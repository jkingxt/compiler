...
//extern void outputTree(struct TreeNode *treeRoot);
...
//在遍历树时使用的全局变量
FieldList pItem;//指向符号表中某一项
FieldList pCmp;//比较参数表。
FieldList pFunc; //指向符号表中函数项
Type pType;		//指向Specifier的syn_type
FieldList symbol_table = NULL; //符号表，用链表实现。
